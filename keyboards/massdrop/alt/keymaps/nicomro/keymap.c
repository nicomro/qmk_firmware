...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN2] = LAYOUT_65_ansi_blocker(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, _______, LM(CTL, MOD_LCTL),                  _______,                            _______, _______, _______, _______, _______  \
    ),
    ...
    [MAC2] = LAYOUT_65_ansi_blocker(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        KC_LCTL, MO(FNC), LM(CTL, MOD_LGUI),                  _______,                            _______, KC_RGUI, _______, _______, _______  \
    ),
    [CTL] = LAYOUT_65_ansi_blocker(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, KC_M,    KC_RBRC, KC_F,    KC_L,    KC_J,    KC_X,    KC_S,    KC_D,    KC_R,    KC_E,    _______, _______, _______, _______, \
        _______, KC_A,    KC_K,    KC_I,    KC_SLSH, KC_COMM, KC_DOT,  KC_P,    KC_B,    KC_O,    _______, _______,          _______, _______, \
        _______, KC_LBRC, KC_C,    KC_H,    KC_U,    KC_Q,    KC_SCLN, KC_QUOT, _______, _______, _______, _______,          _______, _______, \
    ...
    [CNF] = LAYOUT_65_ansi_blocker(
        _______, DF(WIN), DF(WIN2),DF(MAC), DF(MAC2),_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
