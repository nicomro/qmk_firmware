...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN] = LAYOUT_65_ansi_blocker(
        ...
        KC_LALT, LT(FNC, KC_LGUI), KC_LCTL,                   KC_SPC,                             KC_RALT, KC_LGUI, KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [MAC] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        KC_LCTL, MO(FNC), KC_LGUI,                            _______,                            _______, KC_RGUI, _______, _______, _______  \
    ),
    [FNC] = LAYOUT_65_ansi_blocker(
        ...
        MO(CNF), _______, _______,                            _______,                            _______, _______, KC_HOME, KC_PGDN, KC_END   \
    ),
    [CNF] = LAYOUT_65_ansi_blocker(
        _______, DF(WIN), DF(MAC), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
